                ...
                <div className='container mx-auto px-4'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                    ...
                    <div className='bg-background rounded-lg shadow-sm p-6'>
                      ...
                      <p className='text-muted-foreground font-body'>Каждое наше изделие создается с любовью и вниманием к деталям, сочетая традиционные техники и инновации.</p>
                    </div>
                    {/* Каточка ценности 3 */}
                    <div className='bg-background rounded-lg shadow-sm p-6'>
                      <div className='w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4'>
                      ...
                      <h3 className='text-xl font-display mb-2'>Клиентоориентированность</h3>
                      <p className='text-muted-foreground font-body'>Мы стремимся превзойти ожидания наших клиентов, создавая индивидуальные десерты для особых случаев.</p>
                    </div>
